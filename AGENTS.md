...
| 대상 파일 | 작업지시서 표기 |
|---|---|
| index.html | `C:\dev\apps\study\index.html` |
| style.css | `C:\dev\apps\study\style.css` |
| js/config.js | `C:\dev\apps\study\js\config.js` |
| js/storage.js | `C:\dev\apps\study\js\storage.js` |
| js/sync.js | `C:\dev\apps\study\js\sync.js` |
| js/calendar.js | `C:\dev\apps\study\js\calendar.js` |
| js/ui.js | `C:\dev\apps\study\js\ui.js` |
| js/review.js | `C:\dev\apps\study\js\review.js` |
| js/lesson.js | `C:\dev\apps\study\js\lesson.js` |
| js/progress.js | `C:\dev\apps\study\js\progress.js` |
| js/practice.js | `C:\dev\apps\study\js\practice.js` |
| js/stats.js | `C:\dev\apps\study\js\stats.js` |
| js/swipe.js | `C:\dev\apps\study\js\swipe.js` |
| js/app.js | `C:\dev\apps\study\js\app.js` |
| gas/Code.js | `C:\dev\apps\study\gas\Code.js` |
| AGENTS.md | `C:\dev\apps\study\AGENTS.md` |
| docs/EN-core.md | `C:\dev\apps\study\docs\EN-core.md` |
| docs/EN-method.md | `C:\dev\apps\study\docs\EN-method.md` |
| docs/EN-ref.md | `C:\dev\apps\study\docs\EN-ref.md` |
| docs/JA-core.md | `C:\dev\apps\study\docs\JA-core.md` |
| docs/JA-method.md | `C:\dev\apps\study\docs\JA-method.md` |
| docs/JA-ref.md | `C:\dev\apps\study\docs\JA-ref.md` |

**규칙:**
- `파일: style.css` ❌ → `파일: C:\dev\apps\study\style.css` ✅
...
**PowerShell 치환 예시:**
```powershell
$file = 'C:\dev\apps\study\AGENTS.md'
...
|---|---|---|---|
| docs/EN-core.md | `C:\dev\apps\study\docs\EN-core.md` | `https://raw.githubusercontent.com/leftjap/study/main/docs/EN-core.md` | 영어 세션 규칙 (매 세션) |
| docs/EN-method.md | `C:\dev\apps\study\docs\EN-method.md` | `https://raw.githubusercontent.com/leftjap/study/main/docs/EN-method.md` | 영어 방법론 (첫 세션/점검) |
| docs/EN-ref.md | `C:\dev\apps\study\docs\EN-ref.md` | `https://raw.githubusercontent.com/leftjap/study/main/docs/EN-ref.md` | 영어 참조 |
| docs/JA-core.md | `C:\dev\apps\study\docs\JA-core.md` | `https://raw.githubusercontent.com/leftjap/study/main/docs/JA-core.md` | 일본어 세션 규칙 (매 세션) |
| docs/JA-method.md | `C:\dev\apps\study\docs\JA-method.md` | `https://raw.githubusercontent.com/leftjap/study/main/docs/JA-method.md` | 일본어 방법론 (첫 세션/점검) |
| docs/JA-ref.md | `C:\dev\apps\study\docs\JA-ref.md` | `https://raw.githubusercontent.com/leftjap/study/main/docs/JA-ref.md` | 일본어 참조 |
...
**데이터 접근:**
- `getRootFolder(config)` — Google Drive 루트폴더 (`study`)
...
{ // 영어와 동일한 구조 + kanjiQueue: [{ id, kanji, onyomi, kunyomi, koreanReading, mnemonic, exampleWord, learnedDate, currentInterval, nextReview, consecutivePasses, lastResult }], kanjiReadingMap: { rules: [...], entries: [{ kanji, onyomi, korean, similarity, mnemonic }] }, pronunciationMap: { lengthGemination: [...], accentIntonation: [...], koreanErrors: [...] }, // reviewQueue 항목에 reading, meaning 필드 추가 reviewQueue: [{ ..., reading, meaning }] }
...
e. 배포 URL(https://leftjap.github.io/study/)로 접속 상태를 확인한다 (200 vs 404).
